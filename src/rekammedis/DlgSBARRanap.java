                ...
                while(rs.next()){
                    ...
                    try {
                        rs2=koneksi.prepareStatement(
                                ...
                                "validasi_pemeriksaan_sbar_ranap.nik_validator,namavalidator.nama as namavalidator,validasi_pemeriksaan_sbar_ranap.tgl_validasi,validasi_pemeriksaan_sbar_ranap.jam_validasi,validasi_pemeriksaan_sbar_ranap.status_validasi, "+ 
                                "pemeriksaan_ranap_sbar.tulis,pemeriksaan_ranap_sbar.baca,pemeriksaan_ranap_sbar.konfirmasi from pemeriksaan_ranap_sbar LEFT JOIN validasi_pemeriksaan_sbar_ranap ON validasi_pemeriksaan_sbar_ranap.no_rawat = pemeriksaan_ranap_sbar.no_rawat "+
                                "AND validasi_pemeriksaan_sbar_ranap.tgl_perawatan = pemeriksaan_ranap_sbar.tgl_perawatan AND validasi_pemeriksaan_sbar_ranap.jam_rawat = pemeriksaan_ranap_sbar.jam_rawat inner join pegawai on pemeriksaan_ranap_sbar.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_pemeriksaan_sbar_ranap.nik_validator=namavalidator.nik where pemeriksaan_ranap_sbar.no_rawat='"+rs.getString("no_rawat")+"' "+
                        ...
                        if(rs2.next()){
                            ...
                            while(rs2.next()){
                                ...
                                // 1. Cek apakah sudah divalidasi? 
                                // (Cukup cek apakah nik_validator kosong, TIDAK PERLU query Sequel.cariInteger lagi)
                                String nikValidator = rs2.getString("nik_validator");
                                boolean isSudahValidasi = (nikValidator != null && !nikValidator.trim().isEmpty());
                                
                                // 2. Tentukan Warna Background
                                if (!isSudahValidasi) {
                                    // Jika BELUM divalidasi, background jadi MERAH MUDA
                                    stylee = " style=' background-color:#ffcccc '"; 
                                } else {
                                    // Jika SUDAH divalidasi, ikuti aturan Medis/Non-Medis bawaanmu
                                ...
                                // 3. Bersihkan tulisan "null" menjadi strip "-" jika belum divalidasi
                                String namaVal = isSudahValidasi ? rs2.getString("namavalidator") : "-";
                                String tglVal  = isSudahValidasi ? rs2.getString("tgl_validasi") : "Belum";
                                String jamVal  = isSudahValidasi ? rs2.getString("jam_validasi") : "diVerifikasi";
                                
                                // 4. Tentukan Gambar Stempel
                                if (isSudahValidasi) {
                                ...
                                // 5. Cetak ke HTML (Perhatikan penempatan gbrverif yang sudah diperbaiki)
                                htmlContent.append(                              
                                    "<tr class='isi'  >"+
                                        ...
                                        "<td align='center' "+stylee+">" + gbrverif + "<br><b>" + namaVal + "</b><br>" + tglVal + " " + jamVal + "</td>"+
                                    "</tr>"
                                 ); 
                            } 
                        }       
